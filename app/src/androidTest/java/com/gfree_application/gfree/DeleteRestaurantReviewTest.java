...
public class DeleteRestaurantReviewTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void deleteRestaurantReviewTest() {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.restaurant_review_delete_button), withText("Delete Review"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.TableLayout")),
                                        1),
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.deleteReviewsRecyclerView),
                        childAtPosition(
